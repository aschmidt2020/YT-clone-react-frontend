...
function App() {
  ...
  useEffect(() => {
    ...
    async function getPlaylist() {
      const response = await axios.get(`https://www.googleapis.com/youtube/v3/search?relatedToVideoId=${video.id.videoId}&type=video&key=AIzaSyA4kqUjPygvGiu6-LnTwdWwiHUWvqqJAv0`);
