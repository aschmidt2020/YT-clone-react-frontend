...
function App() {
  ...
  async function getPlaylist(video) {
    let response = await axios.get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&relatedToVideoId=${video.id.videoId}&type=video&key=${API_KEY}`);
